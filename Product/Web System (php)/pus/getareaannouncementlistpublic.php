...
/*	while($AARow = mysql_fetch_assoc($AAResult)){
		...
		$sqlQueryAnnouncement = "SELECT * FROM announcement WHERE a_Id='" . $AARow["a_Id"] . "' ORDER BY a_CreatAt";
...
<head>
	...
	<title>Parent Updater System - View Announcement Public</title>
				...
				<table width="973" witdh="100%">
                    ...
                    <?php	
						...
						while ($AARow = mysql_fetch_assoc($AAResult)) {
							...
							echo '<td><a href="displayareaannouncementpublic.php?areaannouncement='. $AARow["AA_Id"] .'&announcement='. $announcementDetails["a_id"] .'&approver='. $approverRow["Approver_Id"] .'&publisher='. $publisherRow["Publisher_Id"] .'"><img src="images\Icon\open-iconic-master\png\check-2x.png"></a></td>'; 
							echo "</tr>";
							echo nl2br("\n");
						}
