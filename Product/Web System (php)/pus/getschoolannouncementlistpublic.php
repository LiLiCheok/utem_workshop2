		...
		<div id="Content">
				...
				<table width="973" witdh="100%">
                    ...
                    <?php	
						 ...
						 */
					 	$sqlQuery = "SELECT * FROM school_announcement";
						...
						while ($SARow = mysql_fetch_assoc($SAResult)) {
							...
							echo '<a href="displayschoolannouncementpublic.php?schoolannouncement='.$SARow["SA_Id"] .'&announcement='.$announcementDetails["a_id"] .'&approver='. $approverRow["Approver_Id"] .'&publisher='. $SARow["SA_Id"] .'"><img src="images\Icon\open-iconic-master\png\check-2x.png"></a></td>';
