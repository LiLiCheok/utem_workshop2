...
<body>
	...
	<div id="Holder"> 
		...
		<p>&nbsp;</p>    
		<div id="Content">
				<h2>View School Announcements</h2>
				<br />
				<br />
				<table width="973" witdh="100%">
                    ...
                    <?php	
						 ...
						 */
					 	$sqlQuery = "SELECT * FROM school_announcement ORDER BY a_id DESC";
						...
						while ($SARow = mysql_fetch_assoc($SAResult)) {
							...
							echo '<a href="displayschoolannouncementschool.php?schoolannouncement='.$SARow["SA_Id"] .'&announcement='.$announcementDetails["a_id"] .'&approver='. $approverRow["Approver_Id"] .'&publisher='. $SARow["SA_Id"] .'"><img src="images\Icon\open-iconic-master\png\check-2x.png"></a></td>';
